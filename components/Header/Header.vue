...
<template>
  <div class="w-full h-full">
    <header ref="referenceRef" class="relative">
      <div
        class="flex justify-between items-center flex-wrap md:flex-nowrap px-4 md:px-10 py-2 md:py-5 w-full h-full border-0 bg-sky-600  border-neutral-200 md:h-20 md:z-10"
      >
        <div class="flex items-center">
          <SfButton
            ...
            class="block md:hidden mr-5 bg-transparent hover:bg-sky-800 hover:text-white active:bg-sky-900 active:text-white"
            @click="openMenu([])"
          >
        ...
        <nav class="flex flex-nowrap justify-end items-center md:ml-10 gap-x-1">
          <SfButton
            ...
            class="text-white bg-transparent hover:bg-sky-800 hover:text-white active:bg-sky-900 active:text-white"
            variant="tertiary"
            square
          >
            <template #prefix>
